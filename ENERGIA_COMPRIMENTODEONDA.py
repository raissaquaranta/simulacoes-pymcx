# This code runs mcx and creates the ENERGY DENSITY output .nii,of a 1.5x6x6 mm of a human aorta
...
cfg["Session"]["ID"] = "ED_660_C"      # 660 nm
# cfg["Session"]["ID"] = "ED_830_C"      # 830 nm
# cfg["Session"]["ID"] = "ED_904_C"      # 904 nm
...
data_mch, data_mc2 = mcx.run(cfg=cfg, flag='--outputtype E --outputformat nii', mcxbin=mcx_local)
